...
public class ParadaInfoActivity extends SherlockActivity {
    ...
    private TextView mTxtNombre, mTxtNumero;
        ...
        public void run() {
            ...
            if (r.nextInt(3) == 0) {
                ...
                Toast.makeText(
                        ...
                        "Parece que el servidor de Tussam no está funcionando bien, toca esperar.\nO también podría ser problema de tu conexión.",
                        Toast.LENGTH_LONG).show();
            } else {
                // Avisa al usuario
                Toast.makeText(ParadaInfoActivity.this,
                        "Parece que el servidor de Tussam no está funcionando bien :(\nO también podría ser problema de tu conexión.", Toast.LENGTH_SHORT)
                        .show();
            }

            
            // Muestra el parrafaco
            if (Datos.getPrefs(ParadaInfoActivity.this).getBoolean("mostrar_explicacion_errores", true)) {

                mExplicacionAbrir = (Button) findViewById(R.id.parada_explicacion_abrir);

                // Condicional para evitar errores en la orientación horizontal, que
                // no tiene el botón
                if (mExplicacionAbrir != null) {
                    mExplicacionAbrir.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View arg0) {
                            new AlertDialog.Builder(ParadaInfoActivity.this).setTitle("Sobre los constantes fallos").setMessage(R.string.explicacion_errores)
                                    .setPositiveButton("Entendido!", new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface arg0, int arg1) {
                                            ocultarExplicacion();
                                        }
                                    }).setNegativeButton("Leer luego", null).create().show();
                        }
                    });
                    mostrarExplicacion();
                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int pos, long arg3) {
                if (mTimeout) {
                    ...
                    if (llegada == null) {
                        ...
                        new AlertDialog.Builder(ParadaInfoActivity.this).setTitle(title).setMessage(display).setNeutralButton("Cerrar", null).create().show();
                    }
                }
            }
        });
        mList.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> arg0, View arg1, int pos, long arg3) {
                ...
                Toast.makeText(ParadaInfoActivity.this, "Se establecido " + mLineas.get(pos).getString("nombre") + " como prioritaria", Toast.LENGTH_SHORT)
                        .show();
                return true;
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.parada, menu);
        return true;
    }
    ...
    private void notificaTimeout() {
        Toast.makeText(ParadaInfoActivity.this, "El servidor está tardando demasiado en responder. Intenta recargar de nuevo más tarde.", Toast.LENGTH_LONG)
                .show();
    }
    ...
    private void ocultarExplicacion() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            ...
            ObjectAnimator ocultar = ObjectAnimator.ofFloat(mExplicacionAbrir, "scaleY", 1, 0);
            ocultar.start();
        } else {
            mExplicacionAbrir.setVisibility(View.GONE);
        }

        Datos.getPrefs(this).edit().putBoolean("mostrar_explicacion_errores", false).commit();
    }

    private void mostrarExplicacion() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            ObjectAnimator muestra = ObjectAnimator.ofFloat(mExplicacionAbrir, "scaleY", 0, 1);
